...
try:
    ...
    from encoder.openus_vmamba.csm_triton import cross_scan_fn, cross_merge_fn

try:
    from .csms6s import selective_scan_fn, selective_scan_flop_jit
except ImportError:
    from encoder.openus_vmamba.csms6s import selective_scan_fn, selective_scan_flop_jit

# Optional FLOPs helper; not used in segmentation forward.
try:
